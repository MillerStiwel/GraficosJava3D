...
public final class Puerta3D extends Applet {
    private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new Puerta3D(args[0]),920,560);
        else
            new MainFrame(new Puerta3D(null),920,560);
    }
    
    public Puerta3D (String filename){
        //se crea el universo
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        objTrans.setScale(0.3); //Escala del objeto
        ...
        try{
           s = file.load(filename == null ? "src\\images\\InteriorDoor.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/puerta.jpg",this);
