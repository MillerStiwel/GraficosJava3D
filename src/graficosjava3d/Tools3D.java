...
public final class Tools3D extends Applet {
    private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new Tools3D(args[0]),1280,720);
        else
            new MainFrame(new Tools3D(null),1280,720);
    }
    
    public Tools3D (String filename){
        //se crea el universo
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        Vector3f luz1Direccion = new Vector3f(1.0f,1.0f,1.0f);
        ...
        objTrans.setScale(0.2); //Escala del objeto
        ...
        try{
           s = file.load(filename == null ? "src\\images\\Weapons_case.obj" : filename);
           //s = file.load(filename == null ? "src\\images\\highD1Obj.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/Herramienta.jpg",this);
